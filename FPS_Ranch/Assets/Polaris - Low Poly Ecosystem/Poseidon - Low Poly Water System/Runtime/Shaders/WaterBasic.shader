Shader "Poseidon/Default/WaterBasic"
{
        ...
        SubShader
    {
        ...
        #pragma surface surfBasic StandardSpecular keepalpha nolightmap nodynlightmap nodirlightmap noshadow vertex:vertexFunction finalcolor:finalColorFunction
