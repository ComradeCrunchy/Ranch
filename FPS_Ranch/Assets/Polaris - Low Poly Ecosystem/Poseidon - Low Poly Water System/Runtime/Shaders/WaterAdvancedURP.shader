    ...
    SubShader
    {
        ...
        Pass 
        {
            ...
            VertexDescription VertexDescriptionFunction(VertexDescriptionInputs IN)
            {
                ...
                #if MESH_NOISE
                    ApplyMeshNoise(positionOS, uv0, vertexColor);
                #endif
                #if WAVE
                    ApplyWaveHQ(positionOS, uv0, vertexColor, crestMask);
                #endif

                ApplyRipple(positionOS, uv0, vertexColor);
                CalculateNormal(positionOS, uv0, vertexColor, normalOS);
                
                description.VertexPosition = positionOS.xyz;
                description.VertexNormal = normalOS;
                description.VertexTangent = tangentOS.xyz;
            ...
            SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
            {
                ...
                half4 reflColor = _Color;
                    ...
                    SampleReflectionTexture(IN.ScreenPosition, IN.WorldSpaceNormal, reflColor);
                #endif
                ...
                half Alpha = lerp(tintColor.a, foamColor.a, foamColor.a);;
