...
public class Pickup : MonoBehaviour
{
    ...
    {
        PlayerCharacterController pickingPlayerCharacter = other.GetComponent<PlayerCharacterController>();

        if (pickingPlayerCharacter != null)
        {
            if (onPick != null)
            {
                onPick.Invoke(pickingPlayerCharacter);
            }
        }
    }
