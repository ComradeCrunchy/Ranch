...
public class PlayerWeaponsManager : MonoBehaviour
{
    ...
    PlayerInputHandler _mPlayerInputHandler;
    PlayerCharacterController _mPlayerCharacterCharacterController;
    ...
    private void Start()
    {
        ...
        _mPlayerInputHandler = GetComponent<PlayerInputHandler>();
        //DebugUtility.HandleErrorIfNullGetComponent<PlayerInputHandler, PlayerWeaponsManager>(m_InputHandler, this, gameObject);

        _mPlayerCharacterCharacterController = GetComponent<PlayerCharacterController>();
    ...
    private void Update()
    {
        ...
        if (activeWeapon && m_WeaponSwitchState == WeaponSwitchState.Up)
        {
            ...
            isAiming = _mPlayerInputHandler.GetAimInputHeld();

            // handle shooting
            bool hasFired = activeWeapon.HandleShootInputs(
                _mPlayerInputHandler.GetFireInputDown(),
                _mPlayerInputHandler.GetFireInputHeld(),
                _mPlayerInputHandler.GetFireInputReleased());
        ...
        {
            int switchWeaponInput = _mPlayerInputHandler.GetSwitchWeaponInput();
            ...
            {
                switchWeaponInput = _mPlayerInputHandler.GetSelectWeaponInput();
                if (switchWeaponInput != 0)
                {
    ...
    {
        _mPlayerCharacterCharacterController.playerCamera.fieldOfView = fov;
    ...
    void UpdateWeaponAiming()
    {
        if (m_WeaponSwitchState == WeaponSwitchState.Up)
        {
            ...
            if (isAiming && activeWeapon)
            {
                ...
                SetFOV(Mathf.Lerp(_mPlayerCharacterCharacterController.playerCamera.fieldOfView, activeWeapon.aimZoomRatio * defaultFOV, aimingAnimationSpeed * Time.deltaTime));
            }
            else
            {
                ...
                SetFOV(Mathf.Lerp(_mPlayerCharacterCharacterController.playerCamera.fieldOfView, defaultFOV, aimingAnimationSpeed * Time.deltaTime));
            }
        }
    }
    ...
    void UpdateWeaponBob()
    {
        ...
        {
            Vector3 playerCharacterVelocity = (_mPlayerCharacterCharacterController.transform.position - m_LastCharacterPosition) / Time.deltaTime;

            // calculate a smoothed weapon bob amount based on how close to our max grounded movement velocity we are
            float characterMovementFactor = 0f;
            if (_mPlayerCharacterCharacterController.isGrounded)
            {
                characterMovementFactor = Mathf.Clamp01(playerCharacterVelocity.magnitude / (_mPlayerCharacterCharacterController.maxSpeedOnGround * _mPlayerCharacterCharacterController.sprintSpeedModifier));
            }
            ...
            m_LastCharacterPosition = _mPlayerCharacterCharacterController.transform.position;
        }
    }
